...
$(window).load(function() {
	equalheight('.content_container .weekly-study');
});
...
$('.close-me.left').on('click',function(){
  $(this).closest('.notification').addClass('close-left');
});
var classes = ['close-left'];
$('.close-me').on('click',function(){
  if(
    $('.notification').hasClass(classes[0]) &&
    $('.notification').hasClass(classes[1]) &&
    $('.notification').hasClass(classes[2])){
      $('.title').fadeOut(500,function(){
        $('.title').text('Refresh to see it again!').fadeIn(500);
      });
    }
});
